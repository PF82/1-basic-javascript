...
function addSum(num) {
  sum = sum + num; // output is undefined, whereas with return statement the output would be 3
}

addSum(3);

addSum is a function without a return statement. The function will change the global sum variable but the returned value of the 
